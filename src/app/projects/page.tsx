...
const projects = [
  {
    ...
    description:
      'A pest control company that specializes in termite and bed bug removal.',
    link: { href: 'https://aa-pest.com', label: 'aa-pest.com' },
    logo: logoAAPest,
  },
  {
    name: 'Knights Creek',
...
export const metadata: Metadata = {
  title: 'Projects',
  description: "Website I've created from scratch.",
}

export default function Projects() {
  return (
    <SimpleLayout
      title="Website I've created from scratch."
